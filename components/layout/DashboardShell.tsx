...
export function DashboardShell() {
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-dark-bg">
      <header className="bg-white dark:bg-dark-card border-b border-neutral-border dark:border-neutral-300">
      ...
      <main className="p-6">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center gap-3 mb-8">
            ...
            <h1 className="text-2xl font-[600] text-black dark:text-dark-text">Dashboard</h1>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white dark:bg-dark-card rounded-[20px] p-6 border border-neutral-border dark:border-neutral-300">
